...
const ChannelModel = {
    ...
    createChannel: async (boardID, channelName) => {
    ...
    addChannelMember: async (channelID, userID, isOwner = false) => {
        await pool.query(
    ...
    findDefaultChannel: async(boardID) => {
        const result = await pool.query(
    ...
    removeAllChannelsMember: async (boardID, userID) => {
